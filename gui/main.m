...
% Last Modified by GUIDE v2.5 27-May-2015 18:19:14
...
% --------------------------------------------------------------------
function menuitem_settings_Callback(hObject, eventdata, handles)
% hObject    handle to menuitem_settings (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --------------------------------------------------------------------
function menuitem_open_instrument_editor_Callback(hObject, eventdata, handles)
% hObject    handle to menuitem_open_instrument_editor (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
instrument_editor;
